...
class Methods:
    ...
    def sendMessage(self, objectGuid:str, fileInline:dict, text:str, messageId:str) -> dict:
        if text:
            result = Tools.checkMetadata(text)
            text , meta_data_parts = result[1] , result[0]
        else:meta_data_parts = False
        input = {
            "object_guid": objectGuid,
        ...
        if meta_data_parts and meta_data_parts != []: input["metadata"] = {"meta_data_parts": meta_data_parts}
    ...
    def baseSendFileInline(self, objectGuid:str, file:str, text:str, messageId:str, fileName:str, type:dict, time:int=None, performer:str=None) -> dict:
        ...
        if type in ["Image", "Video", "Gif", "VideoMessage"]:
            ...
            with open('thumnaile_ai', "w") as file:file.write(thumbInline)
    ...
    def sendMusic(self, objectGuid:str, file:str, messageId:str, text:str, fileName:str, performer:str, time:int) -> dict:
        return self.baseSendFileInline(
            objectGuid=objectGuid,
            file=file,
            text=text,
    ...
    def sendLive(self, objectGuid:str, thumbInline:str | bytes) -> dict:
        return self.network.request(
            method="sendLive",
            input={
