...
class Client(object):
    ...
    def set_admin(self, object_guid:str, member_guid:str, access_list:list=[], custom_title:str=None) -> dict:
    ...
    def set_voice_chat_state(self, object_guid:str, voice_chat_id:str, action:str, participantObjectGuid:str) -> dict:
        return self.methods.setChatVoiceChatState(objectGuid=object_guid, voideChatId=voice_chat_id, action=action, participantObjectGuid=participantObjectGuid)
    ...
    def send_message(self, object_guid:str, file_inline:dict, text:str, message_id:str=None) -> dict:
        return self.methods.sendMessage(objectGuid=object_guid, fileInline=file_inline, text=text, messageId=message_id)
    ...
    def send_music(self, object_guid:str, file:str, message_id:str=None, text:str=None, file_name:str=None, performer:str=None, time:int=0) -> dict:
        return self.methods.sendMusic(objectGuid=object_guid, file=file, text=text, messageId=message_id, fileName=file_name, performer=performer, time=time)
    ...
    def send_live(self, object_guid:str, thumb_inline_file:str | bytes) -> dict:
    ...
    def on_message(self):
        for update in self.methods.handler():yield update
